input.onButtonPressed(Button.A, function () {
    ESP8266_IoT.publishMqttMessage(convertToText(randint(1, 4)), "myhome/1b20/remote-control", ESP8266_IoT.QosList.Qos2)
})
ESP8266_IoT.MqttEvent("myhome/1b20/remote-control", ESP8266_IoT.QosList.Qos2, function (message) {
